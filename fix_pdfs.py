...
def fix_all():
    ...
    print(f"🔧 Opravujem PDF pre {len(product_folders)} produktov...")
    ...
    for folder in product_folders:
        ...
        try:
            # 1. Načítaj dáta (FileAgent ich pri save() aj zachráni cez Rescue)
            product = json.loads(json_path.read_text(encoding="utf-8"))
            
            # 2. Použijeme metódu save, aby sme vytvorili celú štruktúru v1/v2 a nové PDF
    ...
    print("\n✅ Hotovo! Všetky produkty boli pregenerované do v1/v2 balíkov s novými PDF.")
